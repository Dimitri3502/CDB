...
import com.excilys.training.console.validator.Validator;
...
public class Controller {
	...
	public Controller(ComputerDTOValidator computerDTOValidator, ComputerService computerService,
			ComputerUiDTOMapper computerUiDTOMapper, CompanyService companyService, ComputerMapper computerMapper, CompanyMapper companyMapper) {
		super();
